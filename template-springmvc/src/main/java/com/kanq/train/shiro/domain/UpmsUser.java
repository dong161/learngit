package com.kanq.train.shiro.domain;
	...
	/*
		...
		public boolean equals(Object that) {
			...
			return (this.getUserId() == null ? other.getUserId() == null : this
					...
					&& (this.getAvatar() == null ? other.getAvatar() == null : this
							.getAvatar().equals(other.getAvatar()))
		...
		public int hashCode() {
			...
			result = prime * result
					+ ((getAvatar() == null) ? 0 : getAvatar().hashCode());
			result = prime * result
